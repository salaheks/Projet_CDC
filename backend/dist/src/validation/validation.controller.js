...
let ValidationController = class ValidationController {
    ...
    validate(projectId, versionNum) {
        return this.validationService.validateProject(projectId, parseInt(versionNum, 10));
    }
...
__decorate([
    (0, common_1.Post)(':projectId/:versionNum'),
...
__decorate([
    (0, common_1.Get)(':projectId/reports'),
    __param(0, (0, common_1.Param)('projectId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ValidationController.prototype, "getReports", null);
