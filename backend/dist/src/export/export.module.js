...
exports.ExportModule = ExportModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, graph_module_1.GraphModule],
        controllers: [export_controller_1.ExportController],
        providers: [export_service_1.ExportService, terraform_generator_1.TerraformGeneratorService],
